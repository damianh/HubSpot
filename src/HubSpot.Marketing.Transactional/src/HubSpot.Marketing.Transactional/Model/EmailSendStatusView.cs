...
namespace HubSpot.Marketing.Transactional.Model
{
    ...
    public partial class EmailSendStatusView : IEquatable<EmailSendStatusView>, IValidatableObject
    {
        ...
        public enum SendResultEnum
        {
            ...
            /// <summary>
            /// Enum PREVIOUSLYUNSUBSCRIBEDBUSINESSUNIT for value: PREVIOUSLY_UNSUBSCRIBED_BUSINESS_UNIT
            /// </summary>
            [EnumMember(Value = "PREVIOUSLY_UNSUBSCRIBED_BUSINESS_UNIT")]
            PREVIOUSLYUNSUBSCRIBEDBUSINESSUNIT = 42
        }
        ...
        public EmailSendStatusView(string statusId = default(string), SendResultEnum? sendResult = default(SendResultEnum?), DateTime requestedAt = default(DateTime), DateTime startedAt = default(DateTime), DateTime completedAt = default(DateTime), StatusEnum status = default(StatusEnum), EventIdView eventId = default(EventIdView))
        {
