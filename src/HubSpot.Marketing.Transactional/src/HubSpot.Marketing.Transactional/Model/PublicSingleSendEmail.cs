...
namespace HubSpot.Marketing.Transactional.Model
{
    ...
    public partial class PublicSingleSendEmail : IEquatable<PublicSingleSendEmail>, IValidatableObject
    {
        ...
        /// <param name="replyTo">List of Reply-To header values for the email..</param>
        /// <param name="cc">List of email addresses to send as Cc..</param>
        /// <param name="bcc">List of email addresses to send as Bcc..</param>
        public PublicSingleSendEmail(string from = default(string), string to = default(string), string sendId = default(string), List<string> replyTo = default(List<string>), List<string> cc = default(List<string>), List<string> bcc = default(List<string>))
        {
            ...
            if (to == null)
            {
                throw new ArgumentNullException("to is a required property for PublicSingleSendEmail and cannot be null");
            }
            this.To = to;
            this.From = from;
            this.SendId = sendId;
