...
namespace HubSpot.Marketing.Transactional.Model
{
    ...
    public partial class SmtpApiTokenView : IEquatable<SmtpApiTokenView>, IValidatableObject
    {
        ...
        /// <param name="createContact">Indicates whether a contact should be created for email recipients. (required).</param>
        /// <param name="campaignName">A name for the campaign tied to the token. (required).</param>
        public SmtpApiTokenView(string id = default(string), string createdBy = default(string), string password = default(string), string emailCampaignId = default(string), DateTime createdAt = default(DateTime), bool createContact = default(bool), string campaignName = default(string))
        {
        ...
        [DataMember(Name = "emailCampaignId", IsRequired = true, EmitDefaultValue = true)]
        ...
        /// </summary>
        /// <value>Indicates whether a contact should be created for email recipients.</value>
