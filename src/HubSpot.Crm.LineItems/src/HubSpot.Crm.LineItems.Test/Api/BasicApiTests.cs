...
namespace HubSpot.Crm.LineItems.Test.Api
{
    ...
    public class BasicApiTests : IDisposable
    {
        ...
        public void PatchCrmV3ObjectsLineItemsLineItemIdUpdateTest()
        {
            ...
            //string idProperty = null;
            //var response = instance.PatchCrmV3ObjectsLineItemsLineItemIdUpdate(lineItemId, simplePublicObjectInput, idProperty);
        ...
        public void PostCrmV3ObjectsLineItemsCreateTest()
        {
            ...
            //var response = instance.PostCrmV3ObjectsLineItemsCreate(simplePublicObjectInputForCreate);
            //Assert.IsType<SimplePublicObject>(response);
        }
    }
}
