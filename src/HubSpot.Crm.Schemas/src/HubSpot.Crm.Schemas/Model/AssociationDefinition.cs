...
namespace HubSpot.Crm.Schemas.Model
{
    ...
    public partial class AssociationDefinition : IEquatable<AssociationDefinition>, IValidatableObject
    {
        ...
        public AssociationDefinition(string fromObjectTypeId = default(string), string toObjectTypeId = default(string), string name = default(string), string id = default(string), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
