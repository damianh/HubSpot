...
namespace HubSpot.Crm.Schemas.Model
{
    ...
    public partial class ObjectSchema : IEquatable<ObjectSchema>, IValidatableObject
    {
        ...
        public ObjectSchema(ObjectTypeDefinitionLabels labels = default(ObjectTypeDefinitionLabels), List<string> requiredProperties = default(List<string>), List<string> searchableProperties = default(List<string>), string primaryDisplayProperty = default(string), List<string> secondaryDisplayProperties = default(List<string>), bool archived = default(bool), string id = default(string), string fullyQualifiedName = default(string), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime), string objectTypeId = default(string), List<Property> properties = default(List<Property>), List<AssociationDefinition> associations = default(List<AssociationDefinition>), string name = default(string))
        {
        ...
        [DataMember(Name = "requiredProperties", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "searchableProperties", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "secondaryDisplayProperties", IsRequired = true, EmitDefaultValue = true)]
        ...
        /// </summary>
        [DataMember(Name = "objectTypeId", IsRequired = true, EmitDefaultValue = true)]
