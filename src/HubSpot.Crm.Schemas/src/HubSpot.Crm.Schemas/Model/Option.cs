...
namespace HubSpot.Crm.Schemas.Model
{
    ...
    public partial class Option : IEquatable<Option>, IValidatableObject
    {
        ...
        public Option(string label = default(string), string value = default(string), string description = default(string), int displayOrder = default(int), bool hidden = default(bool))
        {
