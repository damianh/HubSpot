...
namespace HubSpot.Cms.UrlRedirects.Test.Api
{
    /// <summary>
    ...
    public class RedirectsApiTests : IDisposable
    {
        ...
        public void GetCmsV3UrlRedirectsGetPageTest()
        {
            ...
            //int? limit = null;
            //bool? archived = null;
            //var response = instance.GetCmsV3UrlRedirectsGetPage(createdAt, createdAfter, createdBefore, updatedAt, updatedAfter, updatedBefore, sort, after, limit, archived);
            //Assert.IsType<CollectionResponseWithTotalUrlMappingForwardPaging>(response);
        }
