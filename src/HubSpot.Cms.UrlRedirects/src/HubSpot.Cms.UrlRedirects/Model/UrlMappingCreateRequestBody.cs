...
namespace HubSpot.Cms.UrlRedirects.Model
{
    ...
    public partial class UrlMappingCreateRequestBody : IEquatable<UrlMappingCreateRequestBody>, IValidatableObject
    {
        ...
        public UrlMappingCreateRequestBody(int precedence = default(int), bool isOnlyAfterNotFound = default(bool), bool isMatchFullUrl = default(bool), bool isMatchQueryString = default(bool), bool isPattern = default(bool), bool isTrailingSlashOptional = default(bool), bool isProtocolAgnostic = default(bool), string routePrefix = default(string), string destination = default(string), int redirectStyle = default(int))
        {
