...
namespace HubSpot.Crm.Accounting.Model
{
    ...
    public partial class InvoiceCreatePaymentRequest : IEquatable<InvoiceCreatePaymentRequest>, IValidatableObject
    {
        ...
        public InvoiceCreatePaymentRequest(decimal amountPaid = default(decimal), string currencyCode = default(string), DateTime paymentDateTime = default(DateTime), string externalPaymentId = default(string))
        {
        ...
        [DataMember(Name = "amountPaid", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "paymentDateTime", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "externalPaymentId", IsRequired = true, EmitDefaultValue = true)]
