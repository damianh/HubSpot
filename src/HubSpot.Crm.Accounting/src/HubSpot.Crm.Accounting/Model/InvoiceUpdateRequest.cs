...
namespace HubSpot.Crm.Accounting.Model
{
    ...
    public partial class InvoiceUpdateRequest : IEquatable<InvoiceUpdateRequest>, IValidatableObject
    {
        ...
        public InvoiceUpdateRequest(string externalInvoiceNumber = default(string), string currencyCode = default(string), DateTime dueDate = default(DateTime), string externalRecipientId = default(string), long receivedByRecipientDate = default(long), bool isVoided = default(bool), string receivedByCustomerDate = default(string), string invoiceNumber = default(string))
        {
        ...
        /// <example>&quot;2020-04-01T13:14:15.678Z&quot;</example>
