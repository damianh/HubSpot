...
namespace HubSpot.Crm.Accounting.Model
{
    ...
    public partial class AccountingAppUrls : IEquatable<AccountingAppUrls>, IValidatableObject
    {
        ...
        [DataMember(Name = "getInvoiceUrl", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "searchCustomerUrl", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "getInvoicePdfUrl", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "customerUrlTemplate", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "productUrlTemplate", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "invoiceUrlTemplate", IsRequired = true, EmitDefaultValue = true)]
