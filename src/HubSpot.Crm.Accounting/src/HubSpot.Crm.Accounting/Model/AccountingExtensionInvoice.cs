...
namespace HubSpot.Crm.Accounting.Model
{
    ...
    public partial class AccountingExtensionInvoice : IEquatable<AccountingExtensionInvoice>, IValidatableObject
    {
        ...
        public AccountingExtensionInvoice(decimal amountDue = default(decimal), decimal balance = default(decimal), DateTime dueDate = default(DateTime), string invoiceNumber = default(string), string customerId = default(string), string currency = default(string), string invoiceLink = default(string), string customerName = default(string), StatusEnum status = default(StatusEnum))
        {
        ...
        /// <example>&quot;https://myapp.com/invoices/1243a2&quot;</example>
        [DataMember(Name = "invoiceLink", IsRequired = true, EmitDefaultValue = true)]
