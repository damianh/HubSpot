...
namespace HubSpot.Crm.Accounting.Model
{
    ...
    public partial class ActionResponse : IEquatable<ActionResponse>, IValidatableObject
    {
        ...
        public ActionResponse(StatusEnum status = default(StatusEnum), DateTime requestedAt = default(DateTime), DateTime startedAt = default(DateTime), DateTime completedAt = default(DateTime), Dictionary<string, string> links = default(Dictionary<string, string>))
        {
            this.Status = status;
