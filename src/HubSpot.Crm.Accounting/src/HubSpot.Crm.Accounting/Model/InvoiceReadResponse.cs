...
namespace HubSpot.Crm.Accounting.Model
{
    ...
    public partial class InvoiceReadResponse : IEquatable<InvoiceReadResponse>, IValidatableObject
    {
        ...
        public InvoiceReadResponse(string externalInvoiceNumber = default(string), decimal totalAmountBilled = default(decimal), decimal balanceDue = default(decimal), string currencyCode = default(string), DateTime dueDate = default(DateTime), string externalRecipientId = default(string), long receivedByRecipientDate = default(long), long externalCreateDateTime = default(long), bool isVoided = default(bool), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime), DateTime archivedAt = default(DateTime), bool archived = default(bool), string externalAccountId = default(string), InvoiceStatusEnum invoiceStatus = default(InvoiceStatusEnum), string id = default(string))
        {
        ...
        [DataMember(Name = "totalAmountBilled", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "balanceDue", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "externalRecipientId", IsRequired = true, EmitDefaultValue = true)]
