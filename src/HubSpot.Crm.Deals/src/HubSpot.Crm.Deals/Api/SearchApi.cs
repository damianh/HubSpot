...
namespace HubSpot.Crm.Deals.Api
{
    ...
    public interface ISearchApiSync : IApiAccessor
    {
        ...
        CollectionResponseWithTotalSimplePublicObjectForwardPaging PostCrmV3ObjectsDealsSearchDoSearch(PublicObjectSearchRequest publicObjectSearchRequest, int operationIndex = 0);
        ...
        ApiResponse<CollectionResponseWithTotalSimplePublicObjectForwardPaging> PostCrmV3ObjectsDealsSearchDoSearchWithHttpInfo(PublicObjectSearchRequest publicObjectSearchRequest, int operationIndex = 0);
    ...
    public interface ISearchApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<CollectionResponseWithTotalSimplePublicObjectForwardPaging> PostCrmV3ObjectsDealsSearchDoSearchAsync(PublicObjectSearchRequest publicObjectSearchRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<CollectionResponseWithTotalSimplePublicObjectForwardPaging>> PostCrmV3ObjectsDealsSearchDoSearchWithHttpInfoAsync(PublicObjectSearchRequest publicObjectSearchRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class SearchApi : ISearchApi
    {
        ...
        /// <returns></returns>
        public SearchApi(HubSpot.Crm.Deals.Client.Configuration configuration)
        {
        ...
        public SearchApi(HubSpot.Crm.Deals.Client.ISynchronousClient client, HubSpot.Crm.Deals.Client.IAsynchronousClient asyncClient, HubSpot.Crm.Deals.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>CollectionResponseWithTotalSimplePublicObjectForwardPaging</returns>
        public CollectionResponseWithTotalSimplePublicObjectForwardPaging PostCrmV3ObjectsDealsSearchDoSearch(PublicObjectSearchRequest publicObjectSearchRequest, int operationIndex = 0)
        {
            HubSpot.Crm.Deals.Client.ApiResponse<CollectionResponseWithTotalSimplePublicObjectForwardPaging> localVarResponse = PostCrmV3ObjectsDealsSearchDoSearchWithHttpInfo(publicObjectSearchRequest);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CollectionResponseWithTotalSimplePublicObjectForwardPaging</returns>
        public HubSpot.Crm.Deals.Client.ApiResponse<CollectionResponseWithTotalSimplePublicObjectForwardPaging> PostCrmV3ObjectsDealsSearchDoSearchWithHttpInfo(PublicObjectSearchRequest publicObjectSearchRequest, int operationIndex = 0)
        {
            // verify the required parameter 'publicObjectSearchRequest' is set
            if (publicObjectSearchRequest == null)
            {
                throw new HubSpot.Crm.Deals.Client.ApiException(400, "Missing required parameter 'publicObjectSearchRequest' when calling SearchApi->PostCrmV3ObjectsDealsSearchDoSearch");
            }
            ...
            localVarRequestOptions.Operation = "SearchApi.PostCrmV3ObjectsDealsSearchDoSearch";
            ...
            var localVarResponse = this.Client.Post<CollectionResponseWithTotalSimplePublicObjectForwardPaging>("/crm/v3/objects/deals/search", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of CollectionResponseWithTotalSimplePublicObjectForwardPaging</returns>
        public async System.Threading.Tasks.Task<CollectionResponseWithTotalSimplePublicObjectForwardPaging> PostCrmV3ObjectsDealsSearchDoSearchAsync(PublicObjectSearchRequest publicObjectSearchRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            HubSpot.Crm.Deals.Client.ApiResponse<CollectionResponseWithTotalSimplePublicObjectForwardPaging> localVarResponse = await PostCrmV3ObjectsDealsSearchDoSearchWithHttpInfoAsync(publicObjectSearchRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CollectionResponseWithTotalSimplePublicObjectForwardPaging)</returns>
        public async System.Threading.Tasks.Task<HubSpot.Crm.Deals.Client.ApiResponse<CollectionResponseWithTotalSimplePublicObjectForwardPaging>> PostCrmV3ObjectsDealsSearchDoSearchWithHttpInfoAsync(PublicObjectSearchRequest publicObjectSearchRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'publicObjectSearchRequest' is set
            if (publicObjectSearchRequest == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<CollectionResponseWithTotalSimplePublicObjectForwardPaging>("/crm/v3/objects/deals/search", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
