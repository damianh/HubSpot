...
namespace HubSpot.Crm.Deals.Test.Api
{
    ...
    public class BasicApiTests : IDisposable
    {
        ...
        public void PatchCrmV3ObjectsDealsDealIdUpdateTest()
        {
            ...
            //string idProperty = null;
            //var response = instance.PatchCrmV3ObjectsDealsDealIdUpdate(dealId, simplePublicObjectInput, idProperty);
        ...
        public void PostCrmV3ObjectsDealsCreateTest()
        {
            ...
            //var response = instance.PostCrmV3ObjectsDealsCreate(simplePublicObjectInputForCreate);
            //Assert.IsType<SimplePublicObject>(response);
        }
    }
}
