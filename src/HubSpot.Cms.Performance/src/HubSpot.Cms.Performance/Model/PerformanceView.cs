...
using OpenAPIDateConverter = HubSpot.Cms.Performance.Client.OpenAPIDateConverter;

namespace HubSpot.Cms.Performance.Model
{
    /// <summary>
    ...
    public partial class PerformanceView : IEquatable<PerformanceView>, IValidatableObject
    {
        ...
        public PerformanceView(long startTimestamp = default(long), long endTimestamp = default(long), string startDatetime = default(string), string endDatetime = default(string), int totalRequests = default(int), int cacheHits = default(int), decimal cacheHitRate = default(decimal), int totalRequestTime = default(int), int avgOriginResponseTime = default(int), int responseTimeMs = default(int), int _100x = default(int), int _20x = default(int), int _30x = default(int), int _40x = default(int), int _50x = default(int), int _403 = default(int), int _404 = default(int), int _500 = default(int), int _504 = default(int), int _50th = default(int), int _95th = default(int), int _99th = default(int))
        {
        ...
        [DataMember(Name = "startTimestamp", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "endTimestamp", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "totalRequests", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "cacheHits", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "cacheHitRate", IsRequired = true, EmitDefaultValue = true)]
        public decimal CacheHitRate { get; set; }

        /// <summary>
        /// Gets or Sets TotalRequestTime
        /// </summary>
        [DataMember(Name = "totalRequestTime", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "avgOriginResponseTime", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "responseTimeMs", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "100X", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "20X", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "30X", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "40X", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "50X", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "403", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "404", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "504", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "50th", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "95th", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "99th", IsRequired = true, EmitDefaultValue = true)]
