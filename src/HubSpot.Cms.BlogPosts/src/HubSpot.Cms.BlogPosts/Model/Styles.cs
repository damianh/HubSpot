...
namespace HubSpot.Cms.BlogPosts.Model
{
    ...
    public partial class Styles : IEquatable<Styles>, IValidatableObject
    {
        ...
        /// </summary>
        [DataMember(Name = "verticalAlignment", IsRequired = true, EmitDefaultValue = true)]
        ...
        /// </summary>
        [DataMember(Name = "flexboxPositioning", IsRequired = true, EmitDefaultValue = true)]
        ...
        /// </summary>
        [DataMember(Name = "backgroundImage", IsRequired = true, EmitDefaultValue = true)]
        public BackgroundImage BackgroundImage { get; set; }

        /// <summary>
        /// Gets or Sets BackgroundGradient
        /// </summary>
        [DataMember(Name = "backgroundGradient", IsRequired = true, EmitDefaultValue = true)]
        public Gradient BackgroundGradient { get; set; }

        /// <summary>
        /// Gets or Sets MaxWidthSectionCentering
        /// </summary>
        [DataMember(Name = "maxWidthSectionCentering", IsRequired = true, EmitDefaultValue = true)]
