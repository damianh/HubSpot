...
namespace HubSpot.Cms.BlogPosts.Model
{
    ...
    public partial class BatchResponseBlogPost : IEquatable<BatchResponseBlogPost>, IValidatableObject
    {
        ...
        public BatchResponseBlogPost(StatusEnum status = default(StatusEnum), List<BlogPost> results = default(List<BlogPost>), DateTime requestedAt = default(DateTime), DateTime startedAt = default(DateTime), DateTime completedAt = default(DateTime), Dictionary<string, string> links = default(Dictionary<string, string>))
        {
            this.Status = status;
