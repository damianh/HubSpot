...
namespace HubSpot.Cms.BlogPosts.Model
{
    ...
    public partial class LayoutSection : IEquatable<LayoutSection>, IValidatableObject
    {
        ...
        /// </summary>
        [DataMember(Name = "rowMetaData", IsRequired = true, EmitDefaultValue = true)]
        ...
        /// </summary>
        [DataMember(Name = "cssStyle", IsRequired = true, EmitDefaultValue = true)]
        public string CssStyle { get; set; }

        /// <summary>
        /// Gets or Sets CssId
        /// </summary>
        [DataMember(Name = "cssId", IsRequired = true, EmitDefaultValue = true)]
