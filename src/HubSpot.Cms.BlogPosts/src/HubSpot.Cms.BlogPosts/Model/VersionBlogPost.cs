...
namespace HubSpot.Cms.BlogPosts.Model
{
    ...
    public partial class VersionBlogPost : IEquatable<VersionBlogPost>, IValidatableObject
    {
        ...
        public VersionBlogPost(BlogPost _object = default(BlogPost), VersionUser user = default(VersionUser), string id = default(string), DateTime updatedAt = default(DateTime))
        {
