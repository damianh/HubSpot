...
namespace HubSpot.Cms.Authors.Model
{
    ...
    public partial class BlogAuthor : IEquatable<BlogAuthor>, IValidatableObject
    {
        ...
        public BlogAuthor(string id = default(string), string fullName = default(string), string email = default(string), string slug = default(string), LanguageEnum language = default(LanguageEnum), long translatedFromId = default(long), string name = default(string), string displayName = default(string), string bio = default(string), string website = default(string), string twitter = default(string), string facebook = default(string), string linkedin = default(string), string avatar = default(string), DateTime created = default(DateTime), DateTime updated = default(DateTime), DateTime deletedAt = default(DateTime))
        {
        ...
        [DataMember(Name = "linkedin", IsRequired = true, EmitDefaultValue = true)]
