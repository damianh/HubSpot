...
namespace HubSpot.Cms.Authors.Model
{
    ...
    public partial class BatchResponseBlogAuthor : IEquatable<BatchResponseBlogAuthor>, IValidatableObject
    {
        ...
        public BatchResponseBlogAuthor(StatusEnum status = default(StatusEnum), List<BlogAuthor> results = default(List<BlogAuthor>), DateTime requestedAt = default(DateTime), DateTime startedAt = default(DateTime), DateTime completedAt = default(DateTime), Dictionary<string, string> links = default(Dictionary<string, string>))
        {
            this.Status = status;
