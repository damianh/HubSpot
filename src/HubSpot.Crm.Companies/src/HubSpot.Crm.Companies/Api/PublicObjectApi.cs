...
namespace HubSpot.Crm.Companies.Api
{
    ...
    public interface IPublicObjectApiSync : IApiAccessor
    {
        ...
        SimplePublicObject PostCrmV3ObjectsCompaniesMergeMerge(PublicMergeInput publicMergeInput, int operationIndex = 0);
        ...
        ApiResponse<SimplePublicObject> PostCrmV3ObjectsCompaniesMergeMergeWithHttpInfo(PublicMergeInput publicMergeInput, int operationIndex = 0);
    ...
    public interface IPublicObjectApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<SimplePublicObject> PostCrmV3ObjectsCompaniesMergeMergeAsync(PublicMergeInput publicMergeInput, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<SimplePublicObject>> PostCrmV3ObjectsCompaniesMergeMergeWithHttpInfoAsync(PublicMergeInput publicMergeInput, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class PublicObjectApi : IPublicObjectApi
    {
        ...
        /// <returns></returns>
        public PublicObjectApi(HubSpot.Crm.Companies.Client.Configuration configuration)
        {
        ...
        public PublicObjectApi(HubSpot.Crm.Companies.Client.ISynchronousClient client, HubSpot.Crm.Companies.Client.IAsynchronousClient asyncClient, HubSpot.Crm.Companies.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>SimplePublicObject</returns>
        public SimplePublicObject PostCrmV3ObjectsCompaniesMergeMerge(PublicMergeInput publicMergeInput, int operationIndex = 0)
        {
            HubSpot.Crm.Companies.Client.ApiResponse<SimplePublicObject> localVarResponse = PostCrmV3ObjectsCompaniesMergeMergeWithHttpInfo(publicMergeInput);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SimplePublicObject</returns>
        public HubSpot.Crm.Companies.Client.ApiResponse<SimplePublicObject> PostCrmV3ObjectsCompaniesMergeMergeWithHttpInfo(PublicMergeInput publicMergeInput, int operationIndex = 0)
        {
            // verify the required parameter 'publicMergeInput' is set
            if (publicMergeInput == null)
            {
                throw new HubSpot.Crm.Companies.Client.ApiException(400, "Missing required parameter 'publicMergeInput' when calling PublicObjectApi->PostCrmV3ObjectsCompaniesMergeMerge");
            }
            ...
            localVarRequestOptions.Operation = "PublicObjectApi.PostCrmV3ObjectsCompaniesMergeMerge";
            ...
            var localVarResponse = this.Client.Post<SimplePublicObject>("/crm/v3/objects/companies/merge", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PostCrmV3ObjectsCompaniesMergeMerge", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of SimplePublicObject</returns>
        public async System.Threading.Tasks.Task<SimplePublicObject> PostCrmV3ObjectsCompaniesMergeMergeAsync(PublicMergeInput publicMergeInput, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            HubSpot.Crm.Companies.Client.ApiResponse<SimplePublicObject> localVarResponse = await PostCrmV3ObjectsCompaniesMergeMergeWithHttpInfoAsync(publicMergeInput, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SimplePublicObject)</returns>
        public async System.Threading.Tasks.Task<HubSpot.Crm.Companies.Client.ApiResponse<SimplePublicObject>> PostCrmV3ObjectsCompaniesMergeMergeWithHttpInfoAsync(PublicMergeInput publicMergeInput, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'publicMergeInput' is set
            if (publicMergeInput == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<SimplePublicObject>("/crm/v3/objects/companies/merge", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
