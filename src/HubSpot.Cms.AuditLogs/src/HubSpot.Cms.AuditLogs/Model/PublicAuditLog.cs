...
namespace HubSpot.Cms.AuditLogs.Model
{
    ...
    public partial class PublicAuditLog : IEquatable<PublicAuditLog>, IValidatableObject
    {
        ...
        public PublicAuditLog(string objectId = default(string), string userId = default(string), DateTime timestamp = default(DateTime), string objectName = default(string), string fullName = default(string), EventEnum _event = default(EventEnum), ObjectTypeEnum objectType = default(ObjectTypeEnum))
        {
