...
namespace HubSpot.Crm.Imports.Model
{
    ...
    public partial class PublicImportResponse : IEquatable<PublicImportResponse>, IValidatableObject
    {
        ...
        public PublicImportResponse(StateEnum state = default(StateEnum), Object importRequestJson = default(Object), DateTime createdAt = default(DateTime), PublicImportMetadata metadata = default(PublicImportMetadata), string importName = default(string), DateTime updatedAt = default(DateTime), bool optOutImport = default(bool), string id = default(string))
        {
            this.State = state;
