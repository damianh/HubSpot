...
namespace HubSpot.Cms.Hubdb.Model
{
    ...
    public partial class HubDbTableRowV3Request : IEquatable<HubDbTableRowV3Request>, IValidatableObject
    {
        ...
        public HubDbTableRowV3Request(string path = default(string), string name = default(string), int childTableId = default(int), Dictionary<string, Object> values = default(Dictionary<string, Object>), int displayIndex = default(int))
        {
