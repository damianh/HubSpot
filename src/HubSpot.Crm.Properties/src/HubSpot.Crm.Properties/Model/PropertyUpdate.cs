...
namespace HubSpot.Crm.Properties.Model
{
    ...
    public partial class PropertyUpdate : IEquatable<PropertyUpdate>, IValidatableObject
    {
        ...
        public PropertyUpdate(string label = default(string), TypeEnum? type = default(TypeEnum?), FieldTypeEnum? fieldType = default(FieldTypeEnum?), string groupName = default(string), string description = default(string), List<OptionInput> options = default(List<OptionInput>), int displayOrder = default(int), bool hidden = default(bool), bool formField = default(bool), string calculationFormula = default(string))
        {
            this.Label = label;
            this.Type = type;
