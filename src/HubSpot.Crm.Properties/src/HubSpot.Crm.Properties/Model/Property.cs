...
namespace HubSpot.Crm.Properties.Model
{
    ...
    public partial class Property : IEquatable<Property>, IValidatableObject
    {
        ...
        public Property(DateTime updatedAt = default(DateTime), DateTime createdAt = default(DateTime), DateTime archivedAt = default(DateTime), string name = default(string), string label = default(string), string type = default(string), string fieldType = default(string), string description = default(string), string groupName = default(string), List<Option> options = default(List<Option>), string createdUserId = default(string), string updatedUserId = default(string), string referencedObjectType = default(string), int displayOrder = default(int), bool calculated = default(bool), bool externalOptions = default(bool), bool archived = default(bool), bool hasUniqueValue = default(bool), bool hidden = default(bool), bool hubspotDefined = default(bool), bool showCurrencySymbol = default(bool), PropertyModificationMetadata modificationMetadata = default(PropertyModificationMetadata), bool formField = default(bool), string calculationFormula = default(string))
        {
