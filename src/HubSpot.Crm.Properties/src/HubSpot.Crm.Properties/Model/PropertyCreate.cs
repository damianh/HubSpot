...
namespace HubSpot.Crm.Properties.Model
{
    ...
    public partial class PropertyCreate : IEquatable<PropertyCreate>, IValidatableObject
    {
        ...
        /// <param name="externalOptions">Applicable only for &#39;enumeration&#39; type properties.  Should be set to true in conjunction with a &#39;referencedObjectType&#39; of &#39;OWNER&#39;.  Otherwise false..</param>
        /// <param name="referencedObjectType">Should be set to &#39;OWNER&#39; when &#39;externalOptions&#39; is true, which causes the property to dynamically pull option values from the current HubSpot users..</param>
        /// <param name="calculationFormula">Represents a formula that is used to compute a calculated property..</param>
        public PropertyCreate(string name = default(string), string label = default(string), TypeEnum type = default(TypeEnum), FieldTypeEnum fieldType = default(FieldTypeEnum), string groupName = default(string), string description = default(string), List<OptionInput> options = default(List<OptionInput>), int displayOrder = default(int), bool hasUniqueValue = default(bool), bool hidden = default(bool), bool formField = default(bool), bool externalOptions = default(bool), string referencedObjectType = default(string), string calculationFormula = default(string))
        {
        ...
        /// </summary>
        /// <value>Applicable only for &#39;enumeration&#39; type properties.  Should be set to true in conjunction with a &#39;referencedObjectType&#39; of &#39;OWNER&#39;.  Otherwise false.</value>
        ...
        /// </summary>
        /// <value>Should be set to &#39;OWNER&#39; when &#39;externalOptions&#39; is true, which causes the property to dynamically pull option values from the current HubSpot users.</value>
        ...
        /// </summary>
        /// <value>Represents a formula that is used to compute a calculated property.</value>
        [DataMember(Name = "calculationFormula", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CalculationFormula: ").Append(CalculationFormula).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(PropertyCreate input)
        {
            ...
            return 
                ...
                (
                    this.CalculationFormula == input.CalculationFormula ||
                    (this.CalculationFormula != null &&
                    this.CalculationFormula.Equals(input.CalculationFormula))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CalculationFormula != null)
                {
                    hashCode = (hashCode * 59) + this.CalculationFormula.GetHashCode();
                }
                return hashCode;
            }
        }
