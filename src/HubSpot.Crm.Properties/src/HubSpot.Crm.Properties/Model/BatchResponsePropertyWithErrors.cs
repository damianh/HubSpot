...
namespace HubSpot.Crm.Properties.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BatchResponsePropertyWithErrors")]
    public partial class BatchResponsePropertyWithErrors : IEquatable<BatchResponsePropertyWithErrors>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchResponsePropertyWithErrors" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BatchResponsePropertyWithErrors() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchResponsePropertyWithErrors" /> class.
        /// </summary>
        ...
        public BatchResponsePropertyWithErrors(StatusEnum status = default(StatusEnum), List<Property> results = default(List<Property>), int numErrors = default(int), List<StandardError> errors = default(List<StandardError>), DateTime requestedAt = default(DateTime), DateTime startedAt = default(DateTime), DateTime completedAt = default(DateTime), Dictionary<string, string> links = default(Dictionary<string, string>))
        {
            this.Status = status;
            // to ensure "results" is required (not null)
            if (results == null)
            {
                throw new ArgumentNullException("results is a required property for BatchResponsePropertyWithErrors and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BatchResponsePropertyWithErrors {\n");
        ...
        {
            return this.Equals(input as BatchResponsePropertyWithErrors);
        }

        /// <summary>
        /// Returns true if BatchResponsePropertyWithErrors instances are equal
        /// </summary>
        /// <param name="input">Instance of BatchResponsePropertyWithErrors to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BatchResponsePropertyWithErrors input)
        {
            if (input == null)
            {
                return false;
