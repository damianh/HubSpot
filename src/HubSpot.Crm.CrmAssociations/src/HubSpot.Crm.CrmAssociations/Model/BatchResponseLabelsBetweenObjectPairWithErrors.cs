...
namespace HubSpot.Crm.CrmAssociations.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BatchResponseLabelsBetweenObjectPairWithErrors")]
    public partial class BatchResponseLabelsBetweenObjectPairWithErrors : IEquatable<BatchResponseLabelsBetweenObjectPairWithErrors>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchResponseLabelsBetweenObjectPairWithErrors" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BatchResponseLabelsBetweenObjectPairWithErrors() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchResponseLabelsBetweenObjectPairWithErrors" /> class.
        /// </summary>
        ...
        public BatchResponseLabelsBetweenObjectPairWithErrors(StatusEnum status = default(StatusEnum), List<LabelsBetweenObjectPair> results = default(List<LabelsBetweenObjectPair>), int numErrors = default(int), List<StandardError> errors = default(List<StandardError>), DateTime requestedAt = default(DateTime), DateTime startedAt = default(DateTime), DateTime completedAt = default(DateTime), Dictionary<string, string> links = default(Dictionary<string, string>))
        {
            this.Status = status;
            // to ensure "results" is required (not null)
            if (results == null)
            {
                throw new ArgumentNullException("results is a required property for BatchResponseLabelsBetweenObjectPairWithErrors and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BatchResponseLabelsBetweenObjectPairWithErrors {\n");
        ...
        {
            return this.Equals(input as BatchResponseLabelsBetweenObjectPairWithErrors);
        }

        /// <summary>
        /// Returns true if BatchResponseLabelsBetweenObjectPairWithErrors instances are equal
        /// </summary>
        /// <param name="input">Instance of BatchResponseLabelsBetweenObjectPairWithErrors to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BatchResponseLabelsBetweenObjectPairWithErrors input)
        {
            if (input == null)
            {
                return false;
