...
namespace HubSpot.Crm.CrmAssociations.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BatchResponsePublicAssociationMultiWithLabelWithErrors")]
    public partial class BatchResponsePublicAssociationMultiWithLabelWithErrors : IEquatable<BatchResponsePublicAssociationMultiWithLabelWithErrors>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchResponsePublicAssociationMultiWithLabelWithErrors" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BatchResponsePublicAssociationMultiWithLabelWithErrors() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchResponsePublicAssociationMultiWithLabelWithErrors" /> class.
        /// </summary>
        ...
        public BatchResponsePublicAssociationMultiWithLabelWithErrors(StatusEnum status = default(StatusEnum), List<PublicAssociationMultiWithLabel> results = default(List<PublicAssociationMultiWithLabel>), int numErrors = default(int), List<StandardError> errors = default(List<StandardError>), DateTime requestedAt = default(DateTime), DateTime startedAt = default(DateTime), DateTime completedAt = default(DateTime), Dictionary<string, string> links = default(Dictionary<string, string>))
        {
            this.Status = status;
            // to ensure "results" is required (not null)
            if (results == null)
            {
                throw new ArgumentNullException("results is a required property for BatchResponsePublicAssociationMultiWithLabelWithErrors and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BatchResponsePublicAssociationMultiWithLabelWithErrors {\n");
        ...
        {
            return this.Equals(input as BatchResponsePublicAssociationMultiWithLabelWithErrors);
        }

        /// <summary>
        /// Returns true if BatchResponsePublicAssociationMultiWithLabelWithErrors instances are equal
        /// </summary>
        /// <param name="input">Instance of BatchResponsePublicAssociationMultiWithLabelWithErrors to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BatchResponsePublicAssociationMultiWithLabelWithErrors input)
        {
            if (input == null)
            {
                return false;
