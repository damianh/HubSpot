...
namespace HubSpot.Crm.Timeline.Model
{
    ...
    public partial class TimelineEventResponse : IEquatable<TimelineEventResponse>, IValidatableObject
    {
        ...
        public TimelineEventResponse(string id = default(string), string eventTemplateId = default(string), string email = default(string), string objectId = default(string), string utk = default(string), string domain = default(string), DateTime timestamp = default(DateTime), Dictionary<string, string> tokens = default(Dictionary<string, string>), Object extraData = default(Object), TimelineEventIFrame timelineIFrame = default(TimelineEventIFrame), string objectType = default(string), DateTime createdAt = default(DateTime))
        {
