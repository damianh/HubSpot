...
namespace HubSpot.Crm.Timeline.Model
{
    ...
    public partial class TimelineEvent : IEquatable<TimelineEvent>, IValidatableObject
    {
        ...
        /// <param name="id">Identifier for the event. This is optional, and we recommend you do not pass this in. We will create one for you if you omit this. You can also use &#x60;{{uuid}}&#x60; anywhere in the ID to generate a unique string, guaranteeing uniqueness..</param>
        public TimelineEvent(string eventTemplateId = default(string), string email = default(string), string objectId = default(string), string utk = default(string), string domain = default(string), DateTime timestamp = default(DateTime), Dictionary<string, string> tokens = default(Dictionary<string, string>), Object extraData = default(Object), TimelineEventIFrame timelineIFrame = default(TimelineEventIFrame), string id = default(string))
        {
        ...
        [DataMember(Name = "eventTemplateId", IsRequired = true, EmitDefaultValue = true)]
