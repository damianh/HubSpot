...
namespace HubSpot.Crm.Timeline.Model
{
    ...
    public partial class TimelineEventTemplate : IEquatable<TimelineEventTemplate>, IValidatableObject
    {
        ...
        public TimelineEventTemplate(string name = default(string), string headerTemplate = default(string), string detailTemplate = default(string), List<TimelineEventTemplateToken> tokens = default(List<TimelineEventTemplateToken>), string id = default(string), string objectType = default(string), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
