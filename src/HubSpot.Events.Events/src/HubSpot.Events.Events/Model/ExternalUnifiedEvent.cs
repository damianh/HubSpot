...
using OpenAPIDateConverter = HubSpot.Events.Events.Client.OpenAPIDateConverter;

namespace HubSpot.Events.Events.Model
{
    /// <summary>
    ...
    public partial class ExternalUnifiedEvent : IEquatable<ExternalUnifiedEvent>, IValidatableObject
    {
        ...
        public ExternalUnifiedEvent(string objectType = default(string), string objectId = default(string), string eventType = default(string), DateTime occurredAt = default(DateTime), string id = default(string), Dictionary<string, string> properties = default(Dictionary<string, string>))
        {
