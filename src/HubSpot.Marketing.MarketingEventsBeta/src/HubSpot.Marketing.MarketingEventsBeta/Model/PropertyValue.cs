...
namespace HubSpot.Marketing.MarketingEventsBeta.Model
{
    ...
    public partial class PropertyValue : IEquatable<PropertyValue>, IValidatableObject
    {
        ...
        public enum SourceEnum
        {
            ...
            /// <summary>
            /// Enum FILEMANAGER for value: FILE_MANAGER
            /// </summary>
            ...
            /// <summary>
            /// Enum INTERNALPROCESSING for value: INTERNAL_PROCESSING
            /// </summary>
            [EnumMember(Value = "INTERNAL_PROCESSING")]
            INTERNALPROCESSING = 75,

            /// <summary>
            /// Enum FORECASTING for value: FORECASTING
            /// </summary>
            [EnumMember(Value = "FORECASTING")]
            FORECASTING = 76,

            /// <summary>
            /// Enum SLACKINTEGRATION for value: SLACK_INTEGRATION
            /// </summary>
            [EnumMember(Value = "SLACK_INTEGRATION")]
            SLACKINTEGRATION = 77,

            /// <summary>
            /// Enum CRMUIBULKACTION for value: CRM_UI_BULK_ACTION
            /// </summary>
            [EnumMember(Value = "CRM_UI_BULK_ACTION")]
            CRMUIBULKACTION = 78,

            /// <summary>
            /// Enum WORKFLOWCONTACTDELETEACTION for value: WORKFLOW_CONTACT_DELETE_ACTION
            /// </summary>
            [EnumMember(Value = "WORKFLOW_CONTACT_DELETE_ACTION")]
            WORKFLOWCONTACTDELETEACTION = 79
        }
        ...
        /// <param name="persistenceTimestamp">persistenceTimestamp.</param>
        /// <param name="useTimestampAsPersistenceTimestamp">useTimestampAsPersistenceTimestamp.</param>
        public PropertyValue(string name = default(string), string value = default(string), long timestamp = default(long), string sourceId = default(string), string sourceLabel = default(string), SourceEnum source = default(SourceEnum), bool selectedByUser = default(bool), long selectedByUserTimestamp = default(long), List<long> sourceVid = default(List<long>), string sourceMetadata = default(string), string requestId = default(string), int updatedByUserId = default(int), long persistenceTimestamp = default(long), bool useTimestampAsPersistenceTimestamp = default(bool))
        {
        ...
        /// </summary>
        [DataMember(Name = "sourceLabel", IsRequired = true, EmitDefaultValue = true)]
        ...
        /// </summary>
        [DataMember(Name = "selectedByUserTimestamp", IsRequired = true, EmitDefaultValue = true)]
        public long SelectedByUserTimestamp { get; set; }

        /// <summary>
        /// Gets or Sets SourceVid
        /// </summary>
        [DataMember(Name = "sourceVid", IsRequired = true, EmitDefaultValue = true)]
        ...
        /// <summary>
        /// Gets or Sets PersistenceTimestamp
        /// </summary>
        [DataMember(Name = "persistenceTimestamp", EmitDefaultValue = false)]
        public long PersistenceTimestamp { get; set; }

        /// <summary>
        /// Gets or Sets UseTimestampAsPersistenceTimestamp
        /// </summary>
        [DataMember(Name = "useTimestampAsPersistenceTimestamp", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PersistenceTimestamp: ").Append(PersistenceTimestamp).Append("\n");
            sb.Append("  UseTimestampAsPersistenceTimestamp: ").Append(UseTimestampAsPersistenceTimestamp).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(PropertyValue input)
        {
            ...
            return 
                ...
                (
                    this.PersistenceTimestamp == input.PersistenceTimestamp ||
                    this.PersistenceTimestamp.Equals(input.PersistenceTimestamp)
                ) && 
                (
                    this.UseTimestampAsPersistenceTimestamp == input.UseTimestampAsPersistenceTimestamp ||
                    this.UseTimestampAsPersistenceTimestamp.Equals(input.UseTimestampAsPersistenceTimestamp)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.PersistenceTimestamp.GetHashCode();
                hashCode = (hashCode * 59) + this.UseTimestampAsPersistenceTimestamp.GetHashCode();
                return hashCode;
            }
        }
