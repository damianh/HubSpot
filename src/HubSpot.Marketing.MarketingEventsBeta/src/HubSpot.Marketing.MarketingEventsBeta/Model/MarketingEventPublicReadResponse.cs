...
namespace HubSpot.Marketing.MarketingEventsBeta.Model
{
    ...
    public partial class MarketingEventPublicReadResponse : IEquatable<MarketingEventPublicReadResponse>, IValidatableObject
    {
        ...
        public MarketingEventPublicReadResponse(string eventName = default(string), string eventType = default(string), DateTime startDateTime = default(DateTime), DateTime endDateTime = default(DateTime), string eventOrganizer = default(string), string eventDescription = default(string), string eventUrl = default(string), bool eventCancelled = default(bool), List<PropertyValue> customProperties = default(List<PropertyValue>), string externalEventId = default(string), int registrants = default(int), int attendees = default(int), int cancellations = default(int), int noShows = default(int), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime), string id = default(string))
        {
        ...
        [DataMember(Name = "eventOrganizer", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "registrants", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "cancellations", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "noShows", IsRequired = true, EmitDefaultValue = true)]
