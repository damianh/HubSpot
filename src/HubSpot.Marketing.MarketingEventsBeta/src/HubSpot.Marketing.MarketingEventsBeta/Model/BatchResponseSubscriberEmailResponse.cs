...
namespace HubSpot.Marketing.MarketingEventsBeta.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BatchResponseSubscriberEmailResponse")]
    public partial class BatchResponseSubscriberEmailResponse : IEquatable<BatchResponseSubscriberEmailResponse>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchResponseSubscriberEmailResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BatchResponseSubscriberEmailResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchResponseSubscriberEmailResponse" /> class.
        /// </summary>
        ...
        public BatchResponseSubscriberEmailResponse(StatusEnum status = default(StatusEnum), List<SubscriberEmailResponse> results = default(List<SubscriberEmailResponse>), int numErrors = default(int), List<StandardError> errors = default(List<StandardError>), DateTime requestedAt = default(DateTime), DateTime startedAt = default(DateTime), DateTime completedAt = default(DateTime), Dictionary<string, string> links = default(Dictionary<string, string>))
        {
            this.Status = status;
            // to ensure "results" is required (not null)
            if (results == null)
            {
                throw new ArgumentNullException("results is a required property for BatchResponseSubscriberEmailResponse and cannot be null");
            }
        ...
        public List<SubscriberEmailResponse> Results { get; set; }
        ...
        {
            return this.Equals(input as BatchResponseSubscriberEmailResponse);
        }

        /// <summary>
        /// Returns true if BatchResponseSubscriberEmailResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of BatchResponseSubscriberEmailResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BatchResponseSubscriberEmailResponse input)
        {
            if (input == null)
            {
                return false;
