...
namespace HubSpot.Automation.Actions.Model
{
    ...
    public partial class ExtensionActionDefinition : IEquatable<ExtensionActionDefinition>, IValidatableObject
    {
        ...
        /// </summary>
        [DataMember(Name = "revisionId", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "inputFields", IsRequired = true, EmitDefaultValue = true)]
        ...
        public List<ExtensionActionDefinitionPatchInputFieldDependenciesInner> InputFieldDependencies { get; set; }
