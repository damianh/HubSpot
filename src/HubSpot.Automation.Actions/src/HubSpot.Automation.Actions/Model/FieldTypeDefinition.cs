...
namespace HubSpot.Automation.Actions.Model
{
    ...
    public partial class FieldTypeDefinition : IEquatable<FieldTypeDefinition>, IValidatableObject
    {
        ...
        public FieldTypeDefinition(string name = default(string), TypeEnum type = default(TypeEnum), FieldTypeEnum? fieldType = default(FieldTypeEnum?), List<Option> options = default(List<Option>), string optionsUrl = default(string), ReferencedObjectTypeEnum? referencedObjectType = default(ReferencedObjectTypeEnum?))
        {
