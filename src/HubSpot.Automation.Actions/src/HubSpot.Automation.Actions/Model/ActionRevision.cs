...
namespace HubSpot.Automation.Actions.Model
{
    ...
    public partial class ActionRevision : IEquatable<ActionRevision>, IValidatableObject
    {
        ...
        public ActionRevision(ExtensionActionDefinition definition = default(ExtensionActionDefinition), DateTime createdAt = default(DateTime), string id = default(string), string revisionId = default(string))
        {
