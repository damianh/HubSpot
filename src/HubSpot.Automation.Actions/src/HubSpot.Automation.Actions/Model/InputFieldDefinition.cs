...
namespace HubSpot.Automation.Actions.Model
{
    ...
    public partial class InputFieldDefinition : IEquatable<InputFieldDefinition>, IValidatableObject
    {
        ...
        /// </summary>
        [DataMember(Name = "typeDefinition", IsRequired = true, EmitDefaultValue = true)]
        ...
        public List<InputFieldDefinition.SupportedValueTypesEnum> SupportedValueTypes { get; set; }
        ...
        public bool Equals(InputFieldDefinition input)
        {
            ...
            return 
                ...
                (
                    ...
                    input.SupportedValueTypes != null &&
