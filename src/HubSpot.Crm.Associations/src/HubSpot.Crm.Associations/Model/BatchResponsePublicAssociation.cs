...
namespace HubSpot.Crm.Associations.Model
{
    ...
    public partial class BatchResponsePublicAssociation : IEquatable<BatchResponsePublicAssociation>, IValidatableObject
    {
        ...
        public BatchResponsePublicAssociation(StatusEnum status = default(StatusEnum), List<PublicAssociation> results = default(List<PublicAssociation>), DateTime requestedAt = default(DateTime), DateTime startedAt = default(DateTime), DateTime completedAt = default(DateTime), Dictionary<string, string> links = default(Dictionary<string, string>))
        {
            this.Status = status;
