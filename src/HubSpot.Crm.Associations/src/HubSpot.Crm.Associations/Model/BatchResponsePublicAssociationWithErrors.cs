...
namespace HubSpot.Crm.Associations.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BatchResponsePublicAssociationWithErrors")]
    public partial class BatchResponsePublicAssociationWithErrors : IEquatable<BatchResponsePublicAssociationWithErrors>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchResponsePublicAssociationWithErrors" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BatchResponsePublicAssociationWithErrors() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchResponsePublicAssociationWithErrors" /> class.
        /// </summary>
        ...
        public BatchResponsePublicAssociationWithErrors(StatusEnum status = default(StatusEnum), List<PublicAssociation> results = default(List<PublicAssociation>), int numErrors = default(int), List<StandardError> errors = default(List<StandardError>), DateTime requestedAt = default(DateTime), DateTime startedAt = default(DateTime), DateTime completedAt = default(DateTime), Dictionary<string, string> links = default(Dictionary<string, string>))
        {
            this.Status = status;
            // to ensure "results" is required (not null)
            if (results == null)
            {
                throw new ArgumentNullException("results is a required property for BatchResponsePublicAssociationWithErrors and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BatchResponsePublicAssociationWithErrors {\n");
        ...
        {
            return this.Equals(input as BatchResponsePublicAssociationWithErrors);
        }

        /// <summary>
        /// Returns true if BatchResponsePublicAssociationWithErrors instances are equal
        /// </summary>
        /// <param name="input">Instance of BatchResponsePublicAssociationWithErrors to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BatchResponsePublicAssociationWithErrors input)
        {
            if (input == null)
            {
                return false;
