...
using OpenAPIDateConverter = HubSpot.Crm.Calling.Client.OpenAPIDateConverter;

namespace HubSpot.Crm.Calling.Model
{
    /// <summary>
    ...
    public partial class SettingsResponse : IEquatable<SettingsResponse>, IValidatableObject
    {
        ...
        public SettingsResponse(string name = default(string), string url = default(string), int height = default(int), int width = default(int), bool isReady = default(bool), bool supportsCustomObjects = default(bool), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for SettingsResponse and cannot be null");
            }
            this.Name = name;
            // to ensure "url" is required (not null)
            if (url == null)
            {
                throw new ArgumentNullException("url is a required property for SettingsResponse and cannot be null");
            }
            this.Url = url;
            this.Height = height;
            this.Width = width;
