...
namespace HubSpot.Crm.Contacts.Api
{
    ...
    public partial class PublicObjectApi : IPublicObjectApi
    {
        ...
        /// <returns></returns>
        public PublicObjectApi(HubSpot.Crm.Contacts.Client.Configuration configuration)
        {
        ...
        public PublicObjectApi(HubSpot.Crm.Contacts.Client.ISynchronousClient client, HubSpot.Crm.Contacts.Client.IAsynchronousClient asyncClient, HubSpot.Crm.Contacts.Client.IReadableConfiguration configuration)
        {
        ...
        {
            HubSpot.Crm.Contacts.Client.ApiResponse<SimplePublicObject> localVarResponse = PostCrmV3ObjectsContactsMergeMergeWithHttpInfo(publicMergeInput);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SimplePublicObject</returns>
        public HubSpot.Crm.Contacts.Client.ApiResponse<SimplePublicObject> PostCrmV3ObjectsContactsMergeMergeWithHttpInfo(PublicMergeInput publicMergeInput, int operationIndex = 0)
        {
            // verify the required parameter 'publicMergeInput' is set
            if (publicMergeInput == null)
            {
                throw new HubSpot.Crm.Contacts.Client.ApiException(400, "Missing required parameter 'publicMergeInput' when calling PublicObjectApi->PostCrmV3ObjectsContactsMergeMerge");
            }
        ...
        {
            HubSpot.Crm.Contacts.Client.ApiResponse<SimplePublicObject> localVarResponse = await PostCrmV3ObjectsContactsMergeMergeWithHttpInfoAsync(publicMergeInput, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SimplePublicObject)</returns>
        public async System.Threading.Tasks.Task<HubSpot.Crm.Contacts.Client.ApiResponse<SimplePublicObject>> PostCrmV3ObjectsContactsMergeMergeWithHttpInfoAsync(PublicMergeInput publicMergeInput, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'publicMergeInput' is set
            if (publicMergeInput == null)
            {
