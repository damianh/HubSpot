...
namespace HubSpot.Crm.CrmExtensions.Model
{
    ...
    public partial class CardResponse : IEquatable<CardResponse>, IValidatableObject
    {
        ...
        public CardResponse(string id = default(string), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime), string title = default(string), CardFetchBody fetch = default(CardFetchBody), CardDisplayBody display = default(CardDisplayBody), CardActions actions = default(CardActions))
        {
