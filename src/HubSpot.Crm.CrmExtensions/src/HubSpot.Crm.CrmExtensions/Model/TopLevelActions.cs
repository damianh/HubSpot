...
namespace HubSpot.Crm.CrmExtensions.Model
{
    ...
    public partial class TopLevelActions : IEquatable<TopLevelActions>, IValidatableObject
    {
        ...
        public TopLevelActions(IFrameActionBody settings = default(IFrameActionBody), IntegratorObjectResultActionsInner primary = default(IntegratorObjectResultActionsInner), List<IntegratorObjectResultActionsInner> secondary = default(List<IntegratorObjectResultActionsInner>))
        {
        ...
        public IntegratorObjectResultActionsInner Primary { get; set; }

        /// <summary>
        /// Gets or Sets Secondary
        /// </summary>
        [DataMember(Name = "secondary", IsRequired = true, EmitDefaultValue = true)]
        public List<IntegratorObjectResultActionsInner> Secondary { get; set; }
