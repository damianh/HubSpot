...
using OpenAPIDateConverter = HubSpot.Analytics.CustomBehavioralEvents.Client.OpenAPIDateConverter;

namespace HubSpot.Analytics.CustomBehavioralEvents.Model
{
    /// <summary>
    ...
    public partial class BehavioralEventHttpCompletionRequest : IEquatable<BehavioralEventHttpCompletionRequest>, IValidatableObject
    {
        ...
        public BehavioralEventHttpCompletionRequest(string utk = default(string), string email = default(string), string eventName = default(string), Dictionary<string, string> properties = default(Dictionary<string, string>), DateTime occurredAt = default(DateTime), string objectId = default(string))
        {
