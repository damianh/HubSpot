...
namespace HubSpot.Crm.FeedbackSubmissions.Model
{
    ...
    public partial class Filter : IEquatable<Filter>, IValidatableObject
    {
        ...
        public Filter(string value = default(string), string highValue = default(string), List<string> values = default(List<string>), string propertyName = default(string), OperatorEnum _operator = default(OperatorEnum))
        {
        ...
        public bool Equals(Filter input)
        {
            ...
            return 
                ...
                (
                    this.HighValue == input.HighValue ||
                    (this.HighValue != null &&
                    this.HighValue.Equals(input.HighValue))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.HighValue.GetHashCode();
                }
                if (this.Values != null)
                {
