...
namespace HubSpot.Cms.SiteSearch.Model
{
    ...
    public partial class IndexedData : IEquatable<IndexedData>, IValidatableObject
    {
        ...
        public IndexedData(string id = default(string), TypeEnum type = default(TypeEnum), Dictionary<string, IndexedField> fields = default(Dictionary<string, IndexedField>))
        {
        ...
        public Dictionary<string, IndexedField> Fields { get; set; }
