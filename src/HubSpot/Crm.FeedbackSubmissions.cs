...
namespace HubSpot.Crm.FeedbackSubmissions
{
    public interface IFeedbackSubmissions
    {
        ...
        Task Archive(string feedbackSubmissionId, CancellationToken cancellationToken = default);
        ...
        Task<SimplePublicObject> Update(string feedbackSubmissionId, [Query(CollectionFormat.Multi)] string idProperty, [Body] SimplePublicObjectInput body, CancellationToken cancellationToken = default);
