...
namespace HubSpot.Crm.Companies
{
    public interface ICompanies
    {
        ...
        Task<SimplePublicObject> Update(string companyId, [Query(CollectionFormat.Multi)] string idProperty, [Body] SimplePublicObjectInput body, CancellationToken cancellationToken = default);
