...
namespace HubSpot.Analytics.CustomBehavioralEvents
{
    public interface ICustomBehavioralEventsAPI
    {
        ...
        /// </summary>
        [Post("/events/v3/send")]
        Task Post/events/v3/send([Body] BehavioralEventHttpCompletionRequest body, CancellationToken cancellationToken = default);
...
namespace HubSpot.Analytics.CustomBehavioralEvents
{
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.19.0.0 (NJsonSchema v10.9.0.0 (Newtonsoft.Json v10.0.0.0))")]
    public partial class BehavioralEventHttpCompletionRequest
    {
        /// <summary>
        /// User token
        /// </summary>
