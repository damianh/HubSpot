...
using System;
namespace HubSpot.Crm.Crm.V3.Objects.Deals.Batch.Read {
    /// <summary>
    /// Builds and executes requests for operations under \crm\v3\objects\deals\batch\read
    /// </summary>
    public class ReadRequestBuilder : BaseRequestBuilder {
        ...
        public ReadRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/crm/v3/objects/deals/batch/read{?archived*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ReadRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ReadRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/crm/v3/objects/deals/batch/read{?archived*}", rawUrl) {
        }
        /// <summary>
