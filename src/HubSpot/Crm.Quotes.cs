...
namespace HubSpot.Crm.Quotes
{
    public interface IQuotes
    {
        ...
        Task<SimplePublicObject> Update(string quoteId, [Query(CollectionFormat.Multi)] string idProperty, [Body] SimplePublicObjectInput body, CancellationToken cancellationToken = default);
