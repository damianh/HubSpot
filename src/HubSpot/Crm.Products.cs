...
namespace HubSpot.Crm.Products
{
    public interface IProducts
    {
        ...
        Task Archive(string productId, CancellationToken cancellationToken = default);
        ...
        Task<SimplePublicObject> Update(string productId, [Query(CollectionFormat.Multi)] string idProperty, [Body] SimplePublicObjectInput body, CancellationToken cancellationToken = default);
