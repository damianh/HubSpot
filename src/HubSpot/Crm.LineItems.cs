...
namespace HubSpot.Crm.LineItems
{
    public interface ILineItems
    {
        ...
        Task<SimplePublicObject> Update(string lineItemId, [Query(CollectionFormat.Multi)] string idProperty, [Body] SimplePublicObjectInput body, CancellationToken cancellationToken = default);
