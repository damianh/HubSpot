...
namespace HubSpot.Events.Events
{
    public interface IHubSpotEventsAPI
    {

        [Get("/events/v3/events")]
        Task<CollectionResponseExternalUnifiedEvent> GetPage([Query(CollectionFormat.Multi)] System.DateTimeOffset? occurredAfter, [Query(CollectionFormat.Multi)] System.DateTimeOffset? occurredBefore, [Query(CollectionFormat.Multi)] string objectType, [Query(CollectionFormat.Multi)] long? objectId, [Query(CollectionFormat.Multi)] string eventType, [Query(CollectionFormat.Multi)] string after, [Query(CollectionFormat.Multi)] string before, [Query(CollectionFormat.Multi)] int? limit, [Query(CollectionFormat.Multi)] IEnumerable<string> sort, CancellationToken cancellationToken = default);
...
namespace HubSpot.Events.Events
{
    ...
    public partial class CollectionResponseExternalUnifiedEvent
    {
        ...
        public System.Collections.Generic.ICollection<ExternalUnifiedEvent> Results { get; set; } = new System.Collections.ObjectModel.Collection<ExternalUnifiedEvent>();
    ...
    /// <br/>```
    /// <br/> {
    /// <br/>      "objectType": "CONTACT",
    /// <br/>      "objectId": 208451632,
    /// <br/>      "eventType": "e_visited_page",
    /// <br/>      "occurredAt": 1567377501421,
    /// <br/>      "id": "leviathan-be3335d3-46f1-3985-988e-ff38e6e7b9d8",
    /// <br/>      "properties": {
    /// <br/>          "hs_url": "https://some-website.com/",
    /// <br/>          "hs_title": "Home",
    /// <br/>          "hs_referrer": "https://some-other-website.com/blog/why-we-love-big-data-and-you-should-too",
    /// <br/>          "hs_userAgent": "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/46.0.2490.80 Safari/537.36",
    /// <br/>          "hs_city": "lund",
    /// <br/>          "hs_region": "m",
    /// <br/>          "hs_country": "se",
    /// <br/>          "hs_session_id" : "leviathan-be3335d3-46f1-3985-988e-ff38e6e7b9d8",
    /// <br/>          "hs_session_source" : "DIRECT"
    /// <br/>      }
    /// <br/>  }      
    /// <br/>```
    /// </summary>
