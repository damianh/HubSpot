...
namespace HubSpot.Crm.Deals
{
    public interface IDeals
    {
        ...
        Task<SimplePublicObject> Update(string dealId, [Query(CollectionFormat.Multi)] string idProperty, [Body] SimplePublicObjectInput body, CancellationToken cancellationToken = default);
