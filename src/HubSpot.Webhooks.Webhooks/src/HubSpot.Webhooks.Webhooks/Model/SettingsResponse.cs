...
namespace HubSpot.Webhooks.Webhooks.Model
{
    ...
    public partial class SettingsResponse : IEquatable<SettingsResponse>, IValidatableObject
    {
        ...
        public SettingsResponse(string targetUrl = default(string), ThrottlingSettings throttling = default(ThrottlingSettings), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
        ...
        /// </summary>
        [DataMember(Name = "throttling", IsRequired = true, EmitDefaultValue = true)]
