...
namespace HubSpot.Cms.Tags.Test.Api
{
    /// <summary>
    ...
    public class BlogTagsApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test PostCmsV3BlogsTagsMultiLanguageAttachToLangGroupAttachToLangGroup
        /// </summary>
        [Fact]
        public void PostCmsV3BlogsTagsMultiLanguageAttachToLangGroupAttachToLangGroupTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //AttachToLangPrimaryRequestVNext attachToLangPrimaryRequestVNext = null;
            //var response = instance.PostCmsV3BlogsTagsMultiLanguageAttachToLangGroupAttachToLangGroup(attachToLangPrimaryRequestVNext);
            //Assert.IsType<Error>(response);
        }

        /// <summary>
        /// Test PostCmsV3BlogsTagsMultiLanguageCreateLanguageVariationCreateLangVariation
        /// </summary>
        [Fact]
        public void PostCmsV3BlogsTagsMultiLanguageCreateLanguageVariationCreateLangVariationTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //TagCloneRequestVNext tagCloneRequestVNext = null;
            //var response = instance.PostCmsV3BlogsTagsMultiLanguageCreateLanguageVariationCreateLangVariation(tagCloneRequestVNext);
            //Assert.IsType<Tag>(response);
        }

        /// <summary>
        /// Test PostCmsV3BlogsTagsMultiLanguageDetachFromLangGroupDetachFromLangGroup
        /// </summary>
        [Fact]
        public void PostCmsV3BlogsTagsMultiLanguageDetachFromLangGroupDetachFromLangGroupTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //DetachFromLangGroupRequestVNext detachFromLangGroupRequestVNext = null;
            //var response = instance.PostCmsV3BlogsTagsMultiLanguageDetachFromLangGroupDetachFromLangGroup(detachFromLangGroupRequestVNext);
            //Assert.IsType<Error>(response);
        }

        /// <summary>
        /// Test PostCmsV3BlogsTagsMultiLanguageUpdateLanguagesUpdateLangs
        /// </summary>
        [Fact]
        public void PostCmsV3BlogsTagsMultiLanguageUpdateLanguagesUpdateLangsTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //UpdateLanguagesRequestVNext updateLanguagesRequestVNext = null;
            //var response = instance.PostCmsV3BlogsTagsMultiLanguageUpdateLanguagesUpdateLangs(updateLanguagesRequestVNext);
            //Assert.IsType<Error>(response);
        }

        /// <summary>
        /// Test PutCmsV3BlogsTagsMultiLanguageSetNewLangPrimarySetLangPrimary
        /// </summary>
        [Fact]
        public void PutCmsV3BlogsTagsMultiLanguageSetNewLangPrimarySetLangPrimaryTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //SetNewLanguagePrimaryRequestVNext setNewLanguagePrimaryRequestVNext = null;
            //instance.PutCmsV3BlogsTagsMultiLanguageSetNewLangPrimarySetLangPrimary(setNewLanguagePrimaryRequestVNext);
        }
    }
}
