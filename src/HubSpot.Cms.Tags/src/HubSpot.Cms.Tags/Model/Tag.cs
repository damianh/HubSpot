...
namespace HubSpot.Cms.Tags.Model
{
    ...
    public partial class Tag : IEquatable<Tag>, IValidatableObject
    {
        ...
        public Tag(string id = default(string), string name = default(string), LanguageEnum language = default(LanguageEnum), long translatedFromId = default(long), DateTime created = default(DateTime), DateTime updated = default(DateTime), DateTime deletedAt = default(DateTime))
        {
