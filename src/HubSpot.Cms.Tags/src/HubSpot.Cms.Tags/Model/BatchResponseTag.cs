...
namespace HubSpot.Cms.Tags.Model
{
    ...
    public partial class BatchResponseTag : IEquatable<BatchResponseTag>, IValidatableObject
    {
        ...
        public BatchResponseTag(StatusEnum status = default(StatusEnum), List<Tag> results = default(List<Tag>), DateTime requestedAt = default(DateTime), DateTime startedAt = default(DateTime), DateTime completedAt = default(DateTime), Dictionary<string, string> links = default(Dictionary<string, string>))
        {
            this.Status = status;
